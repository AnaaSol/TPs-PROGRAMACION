...
#     def setUp(self):
#         self.gestor = Gestor_de_reclamos(os.path.abspath(r'Proyecto_Integrador\data\clasificador_svm.pkl'))
...
#         self.assertEqual(reclamo.get_fecha(),  data[2])
#         self.assertEqual(reclamo.get_ID_usuario(), data[3])
